...
public class AI_Aggressive
    extends AI
{
    public AI_Aggressive()
    {
        super();
    ...
    */
    public Move getMove(Character c, Place p)
    {
        ...
        while (true) {
            ...
            // Heals itself
            else if (action.equals("HEAL") && randCharArtifact != null) {
                return new Go_Heal(c, randCharArtifact.name());
            }
            // Attacks another Player
            else if (action.equals("ATTACK") && randCharArtifact != null) {
                return new Go_Attack(c, randCharArtifact.name());
            }
